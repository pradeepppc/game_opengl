...
Booster::Booster(float x, float y) {
    ...
    this->object1 = create3DObject(GL_TRIANGLES, 12*3, vertex_buffer_data1, COLOR_BOOSTER, GL_FILL);
    this->object2 = create3DObject(GL_TRIANGLES, 12*3, vertex_buffer_data2, COLOR_BOOSTER, GL_FILL);
    }
